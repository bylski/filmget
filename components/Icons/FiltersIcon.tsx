...
const FiltersIcon: React.FC<{className?: string, className2?: string}> = (props) => {
  return (
    <svg
      width="35px"
      height="35px"
    ...
    >
      ...
      <path className={props.className2}d="M9.34,27.41H1.5a1.25,1.25,0,0,1,0-2.5H9.34a1.25,1.25,0,0,1,0,2.5Z" />
